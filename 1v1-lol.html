...
<main id="main" data-cat="action">
    ...
    <div class="Hside">
        ...
        <div id="game" style="width:960px; height:610px;display:none;">
            <iframe id="game-frame" src="about:blank" data-url="https://webglmath.github.io/1v1-lol/" allow="autoplay" scrolling="no" allowfullscreen></iframe>
        </div>
        <div id="loader" class="preview">
            <div id="playGame">
            <img src="https://webglmath.github.io/1v1-lol/logo.png" alt="1v1.LOL | slope-game.github.io Unblocked Game" width="900" height="500" class="glow" />
            <div class="play">
                <div class="playimg">
                <img src="https://webglmath.github.io/1v1-lol/logo.png" alt="1v1.LOL | slope-game.github.io Unblocked Game" width="190" height="190" />
                </div>
...
<script>
     (adsbygoogle = window.adsbygoogle || []).push({});
        ...
        <div class="gameinfos border">
            <div class="gameinfo">
            <h1>1v1.LOL</h1>
            <p id="desc" class="gamedesc"><p><em>1v1.lol</em> is a competitive and tactical third-person shooter and building game where the last player standing is the winner. Build platforms, stairs and walls to enhance your defences as you take out your enemies. If you enjoy Fortnite, you will enjoy this intense battle royale game!</p></p>
                        <h2>How to play 1v1.LOL</h2>
            <div id="control-bot"><ul><li>Mouse to aim</li><li>WASD to move</li><li>Left-Shift to crouch</li><li>F 1 2 3 to cycle between weapons</li><li>Z X V C to cycle between building blocks</li><li>R to rotate a block</li></ul></div>
                    </div>
        </div>
